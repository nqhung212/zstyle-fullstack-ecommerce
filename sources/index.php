               ...
               if(isset($_POST['thanhtoan'])){
                  ...
                  if((isset($_POST['emailnhan']) && $_POST['emailnhan']!='') || $_SESSION['namenhan']!=''  || $_SESSION['emailnhan']!=''  || $_SESSION['sdtnhan']!=''  || $_SESSION['diachinhan']!='' || (isset($_POST['tennhan']) && $_POST['tennhan']!='') || (isset($_POST['sdtnhan']) && $_POST['sdtnhan']!='') || (isset($_POST['diachinhan']) && $_POST['diachinhan']!='')){
                     ...
                     if($errnamenhan=='' && $erremailnhan=='' && $errdiachinhan=='' && $errsdtnhan==''){
                        creatdonhang($_SESSION['iduser'], createma_donhang(),$date,'Chưa thanh toán',($tongtien*(100-$_SESSION['giamgia'])/100),$tendat,$tennhan,$emaildat,$emailnhan,$sdtdat,$sdtnhan,$diachidat,$diachinhan,$phuongthuc,$giaohangnhanh,$_SESSION['id_voucher']);
                     }
                  }else{
                     if($errname=='' && $erremail=='' && $errdiachi=='' && $errsdt==''){
                        
                        creatdonhang($_SESSION['iduser'], createma_donhang(),$date,'Chưa thanh toán',($tongtien*(100-$_SESSION['giamgia'])/100),$tendat,'',$emaildat,'',$sdtdat,'',$diachidat,'',$phuongthuc,$giaohangnhanh,$_SESSION['id_voucher']);
                     }
                  }

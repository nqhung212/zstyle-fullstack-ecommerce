          ...
          <div class="login-box">
            <div class="login-auth__login">
              ...
              <div class="login-regiter">
                ...
                <a href="dangnhap.html" class="regester-link">tại đây </a>
              </div>
            </div>
            <form action="index.php?pg=register" method="post" class="login-form">
              <?php
               ...
               echo '<input name="user" type="text" placeholder="Tên tài khoản" value='.$_SESSION['usernamesignup'].'> <br />
               <div style="color:red; margin-bottom:10px">'.$errusername.'</div>
               <input name="email" type="text" placeholder="Email "  value='.$_SESSION['emailsignup'].'> <br />
               <div style="color:red; margin-bottom:10px">'.$erremail.'</div>
               ...
               <div style="color:red; margin-bottom:10px">'.$errpassword.'</div>
               <div class="login-password">
               ...
               <div style="color:red; margin-bottom:10px">'.$errrepassword.'</div>';
              ?>
